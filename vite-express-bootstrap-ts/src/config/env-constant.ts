...
const constant: Constant = {
	...
	APP_COOKIE_MAX_AGE: process.env.APP_COOKIE_MAX_AGE
		? parseInt(process.env.APP_COOKIE_MAX_AGE)
		: 30 * 24 * 60 * 60 * 1000,
	TOAST_COOKIE_MAX_AGE: process.env.TOAST_COOKIE_MAX_AGE
		? parseInt(process.env.TOAST_COOKIE_MAX_AGE)
		: 5 * 1000,
};
